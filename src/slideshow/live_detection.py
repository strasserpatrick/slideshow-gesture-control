...
#############################################
mode = "all_gestures" # either mandatory or all_gestures

if mode == "mandatory":
    LABEL_MAP = {0: "idle", 1: "right", 2: "left", 3: "rotate"}
    model, scaler, pca = load_params(root_dir / "weights" / "mandatory_model_lessKeypoints" / "model.pkl")
elif mode == "all_gestures":
    LABEL_MAP = {0: "idle", 1: "right", 2: "left", 3: "rotate", 4: "down", 5:"up", 6:"flip_table"}
    model, scaler, pca = load_params(root_dir / "weights" / "all_gestures_model_lessKeypoints" / "model45.pkl")
...
slideshow_root_path = pathlib.Path(__file__).parent / "slideshow"
